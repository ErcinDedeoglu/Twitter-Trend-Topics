...
| 34 | [El Chelsea](http://twitter.com/search?q=El+Chelsea) | El Chelsea is a nickname for the English football club Chelsea FC. It is derived from the name of the area in London where the club is based, Chelsea. In English, it can be translated to mean "The Chelsea". |
...
| 48 | [Escribir](http://twitter.com/search?q=Escribir) | Escribir is a Spanish verb meaning "to write" in English. |
