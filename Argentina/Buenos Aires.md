...
| 30 | [REPECHAJE PARA AGUS Y COTI](http://twitter.com/search?q=REPECHAJE+PARA+AGUS+Y+COTI) | REPECHAJE PARA AGUS Y COTI is a phrase used in Argentina to describe a situation in which two people are competing for something. It literally translates to "rematch for Agus and Coti," suggesting that the two people are in a rematch of some kind. In English, it could be translated as "a showdown between Agus and Coti." |
