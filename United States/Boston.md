...
| Ranking | Topic | Mean |
| ------- | ------------ | ------------ |
| 1 | [Durant](http://twitter.com/search?q=Durant) | Durant is a surname of French origin. It is derived from the Old French word "durant" meaning "enduring". The name is also associated with the Latin word "durare" which means "to last". |
