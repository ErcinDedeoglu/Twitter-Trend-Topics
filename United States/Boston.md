...
| 50 | [The Library](http://twitter.com/search?q=The+Library) | The Library is a term used to refer to a collection of books, periodicals, audio recordings, films, and other materials that are available for use by the public. It is usually housed in a building and managed by librarians. The term can also be used to refer to an online collection of digital resources. |
