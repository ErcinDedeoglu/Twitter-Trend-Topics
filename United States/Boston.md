...
| Ranking | Topic | Mean |
| ------- | ------------ | ------------ |
| 1 | [Hathaway](http://twitter.com/search?q=Hathaway) | Hathaway is an English surname derived from the Old English words "haeth" and "weg," meaning "hedge" and "way," respectively. It is also a given name, usually used as a nickname for someone with the surname. |
...
| 10 | [Bergeron](http://twitter.com/search?q=Bergeron) | Bergeron is a French surname derived from the Old French word bergier, meaning "shepherd". It is also a variant of the German surname Berger. In English, Bergeron can be translated to mean "shepherd" or "shepherd's son". |
| 11 | [Game 1](http://twitter.com/search?q=Game+1) | Game 1 is a term used to refer to the first game of a series or tournament. It is often used in sports, such as baseball, basketball, and football, to refer to the first game of a playoff series or championship. It can also be used in other contexts, such as video games or board games. The phrase implies that the outcome of this game will set the tone for the rest of the series or tournament. |
...
| 49 | [Jesse Chavez](http://twitter.com/search?q=Jesse+Chavez) | Jesse Chavez is a Spanish surname. It is derived from the personal name Jesús, which is the Spanish form of Jesus. The meaning of the name in English is "God is salvation". |
