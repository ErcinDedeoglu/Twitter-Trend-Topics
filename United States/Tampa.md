...
| 2 | [Messaged](http://twitter.com/search?q=Messaged) | In English, "messaged" is a verb that means to send or communicate a message. It can be used in the context of sending an email, text message, or other type of communication. |
...
| 4 | [Melania](http://twitter.com/search?q=Melania) | Melania is a female given name of Greek origin, derived from the Greek word μελαινα (melaina), meaning "black, dark". It is also a variant of the name Melanie. |
