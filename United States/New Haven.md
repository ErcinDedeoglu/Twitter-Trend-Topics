...
| 22 | [Trade in with AT&T](http://twitter.com/search?q=Trade+in+with+AT%26T) | Trade in with AT&T is a program offered by AT&T that allows customers to trade in their old devices for credit towards new ones. Customers can receive up to $650 in credits when they trade in their eligible device. The credits can be used towards the purchase of a new device, or to pay off an existing device balance. |
