...
| 36 | [The Mouse](http://twitter.com/search?q=The+Mouse) | The Mouse is a term used to refer to the computer mouse, which is an input device used to control a computer. It is named for its shape, which resembles a small rodent. The mouse allows users to interact with the computer by pointing and clicking on objects on the screen. |
