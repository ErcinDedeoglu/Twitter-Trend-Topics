...
| 8 | [Jazz Chisholm](http://twitter.com/search?q=Jazz+Chisholm) | Jazz Chisholm is a nickname given to the Bahamian professional baseball player, Jazz Chisholm Jr. The name is derived from his first and last name, and is often used as a way to refer to him in a more informal manner. In English, it simply means "Jazz Chisholm". |
...
| 15 | [THE ALBUM](http://twitter.com/search?q=THE+ALBUM) | The Album is a term used to refer to a collection of songs or recordings released as a single package. It is typically used to refer to a full-length album, but can also be used for an EP or single. The term is derived from the traditional method of releasing music on vinyl records, which were usually packaged in an album with multiple songs. |
| 16 | [Mark Houck](http://twitter.com/search?q=Mark+Houck) | Mark Houck is a surname of German origin. It is derived from the German word "Houck" which means "hill". The name is most commonly found in the United States, where it is often associated with Pennsylvania Dutch culture. |
