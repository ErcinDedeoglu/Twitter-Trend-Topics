...
| Ranking | Topic | Mean |
| ------- | ------------ | ------------ |
| 1 | [jobert](http://twitter.com/search?q=jobert) | Jobert is a slang term used to describe someone who is lazy or unmotivated. It is derived from the word "jobless" and is often used to describe someone who does not have a job or is not actively looking for one. |
