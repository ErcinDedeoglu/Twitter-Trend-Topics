...
| Ranking | Topic | Mean |
| ------- | ------------ | ------------ |
| 1 | [sabrina](http://twitter.com/search?q=sabrina) | Sabrina is a female given name of Latin origin, derived from the name of the river Severn in England. It means "from the boundary river" or "from the source of the Severn". |
