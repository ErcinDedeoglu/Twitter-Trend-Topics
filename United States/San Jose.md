...
| 23 | [Creature Commandos](http://twitter.com/search?q=Creature+Commandos) | Creature Commandos is a comic book series created by DC Comics. It follows a team of monsters, aliens, and robots who are recruited by the US military to fight in World War II. The team is made up of Frankenstein's Monster, a werewolf, a vampire, an intelligent gorilla, and an android. The title "Creature Commandos" refers to the team's mission to command creatures in battle. |
