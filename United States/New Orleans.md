...
| 45 | [And 1](http://twitter.com/search?q=And+1) | And 1 is a term used in basketball to refer to a player scoring a basket and being fouled in the process. This results in the player getting an additional free throw, which if successful, results in the player scoring one more point than they would have otherwise. The phrase is often used as a way of expressing excitement or celebration when someone scores a basket and is fouled. |
