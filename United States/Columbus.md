...
| 40 | [Lazy Sunday](http://twitter.com/search?q=Lazy+Sunday) | "Lazy Sunday" is a phrase used to describe a day spent relaxing and taking it easy. It is usually used to refer to a Sunday, but can be used for any day of the week. The phrase implies that the person is taking a break from their usual activities and enjoying some leisure time. |
...
| 48 | [Hammers](http://twitter.com/search?q=Hammers) | Hammers is a slang term used to refer to firearms, usually handguns. It is derived from the sound that a gun makes when it is fired. |
