...
| 50 | [Slow Motion](http://twitter.com/search?q=Slow+Motion) | Slow motion is a technique used in film and video production to create the illusion of slow movement. It is achieved by filming a scene at a higher frame rate than it will be played back at, or by playing back existing footage at a lower frame rate. Slow motion can be used to emphasize the details of an action, create a more dramatic effect, or to create a comedic effect. |
