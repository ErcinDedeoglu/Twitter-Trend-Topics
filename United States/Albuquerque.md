...
📆 Last Updated: `2023-04-25 05:26:20 UTC`
...
| 47 | [And 1](http://twitter.com/search?q=And+1) | And 1 is a term used in basketball to refer to a player scoring a basket and being fouled in the process. This results in the player getting an additional free throw, which if successful, results in the player scoring one more point than they would have otherwise. The phrase is often used as a way of expressing excitement or celebration when someone scores a basket and is fouled. |
| 48 | [#NBAonTNT](http://twitter.com/search?q=%23NBAonTNT) | #NBAonTNT is a hashtag used on social media to promote the National Basketball Association (NBA) games that are broadcast on the cable television network TNT. It is used to encourage viewers to watch the games and to join in conversations about them. |
| 49 | [Barria](http://twitter.com/search?q=Barria) | Barria is a Basque word meaning "border" or "boundary". It is used to refer to the border between two countries, regions, or territories. |
