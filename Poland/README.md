...
| 15 | [Ozdoba](http://twitter.com/search?q=Ozdoba) | Ozdoba is a Polish word meaning "decoration" or "ornament". It is used to refer to something that adds beauty or visual interest to a space. |
| 16 | [Ochojska](http://twitter.com/search?q=Ochojska) | Ochojska is a Polish surname. It is derived from the word ochota, which means "desire" or "willingness". In English, the name could be translated as "the one who desires". |
...
| 22 | [Zbyszku](http://twitter.com/search?q=Zbyszku) | Zbyszku is a Polish name, derived from the Slavic name Zbyszek. It is a diminutive form of the name Zbigniew, which means "one who brings peace". |
