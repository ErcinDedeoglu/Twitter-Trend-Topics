...
| 5 | [rockström](http://twitter.com/search?q=rockstr%c3%b6m) | Rockström is a Swedish surname derived from the word "rock" meaning "rock" and "ström" meaning "stream". It is a common surname in Sweden, and it can also be found in other Scandinavian countries. In English, Rockström means "stream of rocks". |
...
| 26 | [mikkelsen](http://twitter.com/search?q=mikkelsen) | Mikkelsen is a Danish surname derived from the given name Mikkel, which is a form of the name Michael. The name means "who is like God" in Hebrew. |
...
| 40 | [därför är svt statsmedia](http://twitter.com/search?q=d%c3%a4rf%c3%b6r+%c3%a4r+svt+statsmedia) | "Därför är svt statsmedia" is a Swedish phrase that translates to "Therefore, SVT is a state media". SVT is the acronym for Sveriges Television, the Swedish public service broadcaster. |
...
| 50 | [Drake](http://twitter.com/search?q=Drake) | Drake is a popular English surname derived from the Old Norse byname Draki or the Old English word Draca, both meaning "dragon". It can also refer to a male duck, or a type of boat. |
