...
| 9 | [#FELIP](http://twitter.com/search?q=%23FELIP) | N/A |
| 10 | [COMPLEX EP OUT NOW](http://twitter.com/search?q=COMPLEX+EP+OUT+NOW) | "COMPLEX EP OUT NOW" is a phrase used to announce the release of an EP (Extended Play) album. It means that the EP is now available for purchase or streaming. |
