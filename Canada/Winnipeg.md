...
| 31 | [Rays](http://twitter.com/search?q=Rays) | Rays is a term used to refer to the beams of light that come from the sun. It can also be used to refer to other types of radiation, such as X-rays or gamma rays. In English, it is used to describe something that radiates outward from a source. |
